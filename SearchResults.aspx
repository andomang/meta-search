    ...
    <div class="min-h-screen bg-white">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <div class="flex-1 max-w-2xl relative">
                        ...
                        <asp:TextBox ID="txtSearch" runat="server" CssClass="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="검색어를 입력하세요"></asp:TextBox>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
            <div class="flex flex-col lg:flex-row gap-8">
                <div class="flex-1">
                    <p class="text-sm text-gray-600 mb-6">검색 결과 리스트입니다.</p>
                    <asp:Repeater ID="rptResults" runat="server">
                        <ItemTemplate>
                            <div class="group mb-8">
                                ...
                                <a href='<%# Eval("Url") %>' class="text-2xl text-blue-600 hover:underline"><%# Eval("Title") %></a>
                                <p class="mt-2 text-gray-700"><%# Eval("Description") %></p>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
                ...
                <div class="lg:w-80 space-y-6">
                    <div class="bg-gray-50 border rounded-2xl p-6">
                        <h3 class="font-semibold mb-4">관련 검색어</h3>
                        <div class="space-y-2">
                            <p class="text-blue-600 cursor-pointer hover:underline">ASP.NET Web Forms 강좌</p>
                            <p class="text-blue-600 cursor-pointer hover:underline">Tailwind CSS v4 사용법</p>
                        </div>
                    </div>
                </div>
            </div>
